...
SELECT
	(cast(carga_horaria_opcional_aluno as float8)/ carga_horaria_opcional_curso) as porcentagem_carga_horaria_opcional
FROM 
	carga_horaria_opcional_curso, carga_horaria_opcional_aluno